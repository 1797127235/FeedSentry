...
For accept, include a Simplified Chinese title, a concise Simplified Chinese summary, and a concrete relevance reason.
...
For accept, include a Simplified Chinese title, a concise factual Simplified Chinese summary, and a concrete relevance reason.
